...
class Snake(Tk):
    ...
    def initialSetup(self):
        ...
        self.snake = self.base.create_rectangle(1, 1, 21, 21, fill="Black")
        self.score = 0
        self.scoreDisplay = Label(self, text="Score:{}".format(self.score), font=('Times New Roman', 20, 'bold'))
    ...
    def check_snake_coords(self):
        ...
        if i <= 0 or j <= 0 or ii >= 500 or jj >= 500:
            ...
            self.y = 0
            # gameover
            self.base.create_text(220, 220, text="GAME OVER", font=('Times New Roman', 40, 'bold'), fill='red')
            self.gameStatus = 0
        return
    ...
    def move_snake(self):
        ...
        self.base.create_line(tuple(self.bodycoords), tag='snakebody', width=20, fill="cyan")
        return
    ...
    def updateScore(self):
        self.score += 1
        self.scoreDisplay['text'] = "Your Score : {}".format(self.score)
        return
...
snakeobj = Snake(className="Feed the snake")
while True:
    snakeobj.update()
